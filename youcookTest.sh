RGB_checkpoint_path="/home/ubuntu/backup_kevin/myownTSM_git/checkpoint/TSM_youcook_RGB_resnet50_shift8_blockres_concatAll_conv1d_lr0.00025_dropout0.70_wd0.00050_batch16_segment8_e20_finetune_slice_v1_clipnum500/"
...
python3 test_models_v2.py youcook \
    ...
    --batch_size=1 --clipnums=500 --epoch=20\
    --save-scores=${RGB_checkpoint_path}/youcook_scores
    2> test_err.log
