...
python3 main_yc.py youcook RGB \
	...
	--gd 20 --lr 0.00025 --lr_steps 7 15 --epochs 50 \
	--resume=/home/ubuntu/backup_kevin/myownTSM_git/checkpoint/TSM_youcook_RGB_resnet50_shift8_blockres_concatAll_conv1d_lr0.00025_dropout0.70_wd0.00050_batch16_segment8_e10_finetune_clip500_slice_v3/ckpt_10.pth.tar \
