...
python3 main_yc.py youcook RGB \
	...
	--tune_from=checkpoint/TSM_ucf101_RGB_resnet50_shift8_blockres_concatAll_conv1d_lr0.00025_dropout0.70_wd0.00050_batch16_segment8_e35_extra_finetune_MSTSM_TFDEM_split3/ckpt.best.pth.tar \
	--suffix=MSTSM_image
	2>err.log
