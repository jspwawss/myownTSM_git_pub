...
python3 main_ann_transformer.py youcook RGB \
	...
	--tune_from=/home/ubuntu/backup_kevin/myownTSM_git/checkpoint/TSM_youcook_RGB_resnet50_shift8_blockres_concatAll_conv1d_lr0.00025_dropout0.70_wd0.00050_batch16_segment8_e50_finetune_clip500_slice_v3/ckpt_21.pth.tar \
	--suffix=transformer3 --loss_type=CrossEntropyLoss --clipnums=500
	2>err.log
