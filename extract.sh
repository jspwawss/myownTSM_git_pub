RGB_checkpoint_path="/home/share/Han/checkpoint/TSM_youcook_RGB_resnet50_shift8_blockres_concatAll_conv1d_lr0.00025_dropout0.70_wd0.00050_batch16_segment8_e50_finetune_clip500_slice_v3/"
...
python3 extract.py youcook \
    --weights=${RGB_checkpoint_path}ckpt_21.pth.tar \
    ...
    --save-scores=${RGB_checkpoint_path}feature/
    2> test_err.log
